...
Revision ID: 76173ba2db4a
Revises: 
Create Date: 2025-11-20 23:28:53.232008
...
def upgrade() -> None:
    ...
    sa.Column('id_roles_x_usuario', sa.Uuid(), nullable=False),
    sa.Column('id_usuario', sa.Uuid(), nullable=False),
    sa.Column('id_rol', sa.Uuid(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    sa.Column('id_medico_especialidad', sa.Uuid(), nullable=False),
    sa.Column('id_medico', sa.Uuid(), nullable=False),
    sa.Column('id_especialidad', sa.Uuid(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    sa.Column('id_historia_clinica', sa.Uuid(), nullable=False),
    sa.Column('id_paciente', sa.Uuid(), nullable=False),
    sa.Column('id_medico', sa.Uuid(), nullable=False),
