...
from sqlalchemy.dialects import postgresql # Necesario para usar ARRAY en la definición explícita si fuera necesario, pero sa.ARRAY suele bastar.
...
def upgrade() -> None:
    ...
    # CAMBIO 1: Nombre plural y tipo ARRAY
    ...
    # Actualizado unique constraint con el nombre correcto 'dias_semana'
    sa.UniqueConstraint('id_medico', 'dias_semana', 'hora_inicio', 'fecha_inicio')
    )

    # 10. TABLA ASIGNACION_CONSULTORIOS
    ...
    # CAMBIO 2: Nombre plural y tipo ARRAY
    sa.Column('dias_semana', sa.ARRAY(sa.Integer()), nullable=False),
