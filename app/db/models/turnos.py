...
class TurnoModel(TimestampMixin, Base):
    ...
    paciente = relationship("PacienteModel", back_populates="turnos")
    medico = relationship("MedicoModel", back_populates="turnos")
    consultorio = relationship("ConsultorioModel", back_populates="turnos")

    historia_clinica = relationship("HistoriaClinicaModel", back_populates="turno", uselist=False)
    estado_turno = relationship("EstadoTurnoModel", back_populates="turnos")
    recetas = relationship("RecetaModel", back_populates="turno")
